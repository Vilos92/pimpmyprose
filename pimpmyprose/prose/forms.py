...
class ProseForm( forms.ModelForm ):
	prose_text = forms.CharField( widget = forms.Textarea( attrs = { 'class' : 'pimpProseSubmit', 'onkeyup' : 'getRemainingCharacters(this)' } ), label = '', max_length = 250 )
...
class PimpForm( forms.ModelForm ):
	pimp_text = forms.CharField( widget = forms.Textarea( attrs = { 'class' : 'pimpProseSubmit', 'onkeyup' : 'getRemainingCharacters(this)' } ), label= '', max_length = 250 )
